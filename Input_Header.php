    ...
    <div class="container">
        ...
        <form action="simpan3.php" method="post" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <button type="submit" name="btn_simpan" class="btn btn-success">Simpan</button> <a href="Dashboard.php" class="btn btn-success">Back</a>
        </form>
                    ...
                    <table class="table table-bordered" width='200%'cellspacing="0">
                        ...
                        <tr>
                            ...
                            <td><img src="gambar/<?php echo $data['gambar'];?>" class="rounded" width='100%' alt="Cinque Terre"></td>
                             <td><a href="hapus3.php?id_gambar=<?php echo $data['id_gambar'];?>&gambar=<?php echo $data['gambar'];?> class="btn btn-danger" role="button"onclick="javascript: return confirm('Anda yakin akan hapus data?')"class="btn btn-success">Hapus</a></td>
                        </tr>
